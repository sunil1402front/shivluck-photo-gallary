  ...
  return (
    <nav className="sticky top-0 z-40 bg-gradient-to-r from-indigo-900/80 via-purple-900/80 to-pink-900/70 shadow-2xl px-4 sm:px-8 py-4 backdrop-blur-md border-b border-white/20">
      <div className="max-w-7xl mx-auto">
        ...
        <div
          className={`md:hidden overflow-hidden  border-white/20 transition-all duration-500 ease-in-out ${
            isMobileMenuOpen ? 'max-h-96 opacity-100 translate-y-0' : 'max-h-0 opacity-0 -translate-y-8'
          } transform`}
          style={{ pointerEvents: isMobileMenuOpen ? 'auto' : 'none' }}
        >
          <div className="flex flex-col space-y-4 pt-4 pb-4 border-white/20">
            {/* Shivluck Site */}
            <a
              href="https://shiv-luck-interior.vercel.app/"
              target="_blank"
