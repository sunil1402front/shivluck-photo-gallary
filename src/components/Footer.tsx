export default function Footer() {
  return (
    <footer id="contact" className="relative py-12 mt-20 overflow-hidden bg-gradient-to-b from-transparent to-orange-50/70 dark:to-transparent">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-gray-500 dark:text-gray-400">Transforming spaces with thoughtful, timeless interiors.</p>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="space-y-2 text-gray-600 dark:text-gray-400">
              <p>Email: <a className="underline hover:text-gray-800 dark:hover:text-gray-200" href="mailto:shivluck999@gmail.com">shivluck999@gmail.com</a></p>
              <div className="space-y-1">
                <p className="flex items-center justify-center space-x-2">
                  <span className="text-gray-900 dark:text-gray-100 font-semibold">KP Suthar:</span>
                  <a className="underline hover:text-gray-800 dark:hover:text-gray-200" href="tel:+919898167270">9898167270</a>
                </p>
                <p className="flex items-center justify-center space-x-2">
                  <span className="text-gray-900 dark:text-gray-100 font-semibold">Rajesh Suthar:</span>
                  <a className="underline hover:text-gray-800 dark:hover:text-gray-200" href="tel:+918320785875">8320785875</a>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center md:text-right">
            ...
            <div className="flex justify-center md:justify-end space-x-4">
              <a
                ...
                className="inline-flex items-center space-x-2 rounded-full border border-gray-200/70 bg-white/60 backdrop-blur-md px-4 py-2 text-sm font-semibold text-gray-900 hover:bg-white/80 transition-colors dark:border-white/10 dark:bg-white/10 dark:text-gray-100 dark:hover:bg-white/15"
              >
        ...
        <div className="border-t border-gray-200/70 dark:border-white/10 mt-8 pt-8 text-center">
          <p className="text-gray-500 dark:text-gray-400">&copy; 2024 SHIVLUCK Interior. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
