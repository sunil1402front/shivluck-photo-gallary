...
export default function PhotoCard({ photo, onDeleteClick }: PhotoCardProps) {
  ...
  const tagClasses = 'bg-white/30 backdrop-blur-md border border-white/50 text-gray-900 px-3 py-1 dark:bg-white/10 dark:border-white/10 dark:text-gray-100';
  ...
  return (
    <motion.div
      ...
      <div className="relative">
        ...
        />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-orange-100/60 via-white/30 to-transparent backdrop-blur-xl opacity-0 transition-opacity duration-300 dark:from-white/10 dark:via-white/5" />
        ...
        <div className="absolute inset-x-3 bottom-3 flex items-center justify-between">
          ...
          <div className="pointer-events-auto">
            <button
              ...
              className="inline-flex items-center justify-center h-8 w-8 rounded-full bg-white/30 backdrop-blur-md border border-white/50 text-gray-700 hover:text-red-600 hover:bg-white/50 transition-colors shadow-sm dark:bg-white/10 dark:border-white/10 dark:text-gray-200 dark:hover:bg-white/20"
            >
