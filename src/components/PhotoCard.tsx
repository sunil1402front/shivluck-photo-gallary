  ...
  return (
    <div className="group bg-white rounded-3xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-500 hover:shadow-2xl relative cursor-pointer">
      <div className="relative aspect-square">
        ...
        {/* Open Image Button - Only visible on hover */}
      ...
      <div className="p-6">
        ...
        {/* Footer with category badge and delete button */}
        <div className="flex items-center justify-between">
          {/* Category Badge - Left side */}
          <div className={`bg-gradient-to-r ${footerColor} text-white px-4 py-2 rounded-xl shadow-lg`}>
          ...
          <button
            ...
            className="bg-gradient-to-r from-red-500 to-pink-600 text-white p-2 rounded-full shadow-lg transform hover:scale-110 transition-all duration-300 hover:shadow-xl hover:from-red-600 hover:to-pink-600"
          >
